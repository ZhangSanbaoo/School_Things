...
#define LIBS_SYS "-ldl -lm -lpthread -lssl -lcrypto"
...
#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/usr/local/lib/mariadb/ -lmariadbd -ldl -lm -lpthread -lssl -lcrypto"
#endif
